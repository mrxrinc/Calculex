...
export default class Body extends Component {
  render() {
    // This method needs some refinement to handle animations perfectly
          ...
          <View style={[r.full, r.row]}>
            {
              ...
              Object.entries(_ds).map(([key, btns]) => (
                  ...
                  {btns.map((el, i) => (
                    <View key={i} style={[r.full]}>
                      {el.length === 1 ? (
                        ...
                        <Button
                          title={el}
                          press={() => buttonAction(String(el).toLowerCase())}
                        />
                      ) : (
            ...
            <View style={[r.full]}>
              ...
              <View style={[r.full]}>
                <Button icon="plus" press={() => buttonAction('plus')} />
              </View>
            </View>
          </View>
        </View>
